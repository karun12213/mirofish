...
// Get maxRounds from query params at init to ensure child components get the value immediately
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh doesn't show fullscreen loading to prevent flicker
