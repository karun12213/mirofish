  ...
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        ...
        <button class="demo-btn" @click="demoOpen = true">● Live Demo</button>
      </div>
    </nav>
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a short text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world with up to <span class="highlight-orange">millions of Agents</span> based on its reality seeds. By injecting variables from a God's-eye view, discover the <span class="highlight-code">"local optimal solution"</span> in dynamic environments through complex swarm interactions.
            </p>
            <p class="slogan-text">
              Let the future be rehearsed among Agents, let your decisions prevail.<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby, you can upload unstructured data to initialize the simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Extract reality seeds & inject individual/swarm memory & build GraphRAG</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Extract entity relationships & generate personas & inject simulation params</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & parse prediction reqs & dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent deeply interacts with the post-simulation environment using tools</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Input simulation or prediction requirements in natural language"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
.console-divider span { padding: 0 15px; font-family: var(--font-mono); font-size: 0.7rem; color: #BBB; letter-spacing: 1px; }
