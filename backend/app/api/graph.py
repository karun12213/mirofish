...
def generate_ontology():
    ...
    try:
        ...
        if not simulation_requirement:
            return jsonify({
                "success": False,
                "error": "Please provide simulation requirement"
            }), 400
        ...
        if not document_texts:
            ...
            return jsonify({
                "success": False,
                "error": "Failed to process any document, please check file formats"
            }), 400
...
def build_graph():
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify({
                "success": False,
                "error": "Graph building in progress, do not resubmit. To force rebuild, add force: true",
